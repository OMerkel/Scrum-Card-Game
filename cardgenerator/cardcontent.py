...
cardcontent = [
  ...
  },
  {
    ...
    'en' : 'You worked well at home. Add 2 points to the last roll.',
    'de_title' : 'HEIMARBEIT', 
  ...
  },
  {
    ...
    'en' : 'You caught a cold. Skip your next turn.',
  ...
  },
  {
    ...
    'en' : 'An emergency call informs on an incident in the office. Everyone skips next turn.',
    'de_title' : 'NOTRUF', 
  ...
  },
  {
    ...
    'smiley' : ':-|',
    'en_title' : 'OVERTIME',
    'en' : 'You worked overtime. Draw another card and follow its instruction.',
    'de_title' : 'ÜBERSTUNDEN', 
    'de' : 'Du leistest Überstunden. Ziehe noch eine Karte und befolge die Anweisungen.', 
  },
  {
    'type' : 'solution',
  ...
  },
  {
    ...
    'en' : 'System is very unstable. You test with major difficulties.',
