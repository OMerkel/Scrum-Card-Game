...
Example:
  ...
  >>> svg[0:60]
  "<?xml version='1.0' encoding='UTF-8' standalone='no'?><svg x"
  >>> len(svg)
  2989
...
<rect x='10' y='-25' width='10' height='10' style='fill:#f00;stroke:none;' />
<rect x='20' y='-25' width='10' height='10' style='fill:#0f0;stroke:none;' />
<rect x='30' y='-25' width='10' height='10' style='fill:#00f;stroke:none;' />
</g>
%s</svg>'''
...
<path d="m 239.5,177.6 c -1.8,3.1 -5.2,5.1 -8.9,5.1 l -157.6,0 c -3.6,0 -7,-2 -8.9,-5.1 -1.8,-3.2 -1.8,-7.1 0,-10.3 L 143,30.8 c 1.8,-3.1 5.3,-5.1 9.0,-5.1 3.6,0 7.1,2 8.8,5.1 l 78.8,136.5 c 1.8,3.2 1.8,7.1 0,10.3 z m 5.3,-13.4 -78.7,-136.4 c -2.9,-5.1 -8.3,-8.3 -14.2,-8.3 -6.0,0 -11.5,3.2 -14.5,8.3 L 58.8,164.2 c -3.1,5.1 -3.1,11.4 0,16.5 2.9,5.1 8.5,8.3 14.3,8.3 l 157.6,0 c 5.9,0 11.3,-3.2 14.2,-8.3 3.1,-5.1 3.1,-11.4 0,-16.5 z" style="fill:#fff;stroke:none" />'''
...
typelabel = '''<text x="%s" y="200"><tspan x="%s" y="200" style="font-style:normal;font-variant:normal;font-weight:bold;font-stretch:normal;font-size:%s;line-height:100%%;font-family:Arial;-inkscape-font-specification:'Arial, Bold';text-align:end;writing-mode:lr;text-anchor:end;fill:#fff">%s</tspan></text>'''
...
#        'de': '104px',
  ...
  def svg(self):
    ...
    svg = svgTemplate % ( now, self.pos['x'][0]*10, self.pos['y'][0]*10, svgRect)
